...
def evaluate_metrics(events: list[Event]) -> dict[str, Any]:
    ...
    return {
        ...
        "metrics": {
            ...
            "correct_honeypot_routing_rate": ratio(combined_correct_count, routed_attack_count),
        ...
        "metric_notes": {
            ...
            "correct_honeypot_routing_rate": "selected backend matches semantic expected backend and matching honeypot outcome appears",
